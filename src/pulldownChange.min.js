 ...
 * selector 連動
 * */
$.fn.pulldownChange=function(a,d,c,e,b,f){"undefined"==typeof f&&(f="\u8acb\u9078\u64c7");set_pulldownChangeValue=$("#"+a).eq(0).val();if(!0==b){$("#"+a).empty();b=window.document.getElementById(a);var g=1;b.options[0]=new Option(f,"");for(var h in e)b.options[g]=new Option(h,h),g++;b.selectedIndex=0}window.document.getElementById(d).options[0]=new Option(f,"");$("#"+a).on("change",function(){value=$(this).val();set_pulldownChangeValue=$(this).val();$("#"+d).children().remove();changePulldown=e[value]; changeSellectNode=window.document.getElementById(d);if(""!=value){changeSellectNode.options[0]=new Option(f,"");for(var a=1;a<=changePulldown.length;a++)changeSellectNode.options[a]=new Option(changePulldown[a-1][0].town,changePulldown[a-1][0].town);changeSellectNode.selectedIndex=0;0!=$("#"+c).length&&(changeZipNode=window.document.getElementById(c),changeZipNode.value=changePulldown[0][0].zip)}else changeSellectNode.options[0]=new Option(f,""),0!=$("#"+c).length&&(changeZipNode=window.document.getElementById(c), changeZipNode.value="")});$("#"+d).on("change",function(){value=$(this).val();changePulldown=e[set_pulldownChangeValue];0!=$("#"+c).length&&(_townData=getObjects(changePulldown,"town",value),changeZipNode=window.document.getElementById(c),changeZipNode.value=""!=_townData?_townData[0].zip:"")})};function getObjects(a,d,c){var e=[],b;for(b in a)a.hasOwnProperty(b)&&("object"==typeof a[b]?e=e.concat(getObjects(a[b],d,c)):b==d&&a[d]==c&&e.push(a));return e};
