 ...
 * selector 連動
 * */
$.fn.pulldownChange=function(d,e,b,f,a,c){"undefined"==typeof c&&(c="\u8acb\u9078\u64c7");set_pulldownChangeValue=$("#"+d).eq(0).val();if(!1!=a){$("#"+d).empty();a=window.document.getElementById(d);var g=1;a.options[0]=new Option(c,"");for(var h in f)a.options[g]=new Option(h,h),g++;a.selectedIndex=0}window.document.getElementById(e).options[0]=new Option(c,"");$("#"+d).on("change",function(){value=$(this).val();set_pulldownChangeValue=$(this).val();$("#"+e).children().remove();changePulldown=f[value]; changeSellectNode=window.document.getElementById(e);if(""!=value){changeSellectNode.options[0]=new Option(c,"");for(var a=1;a<=changePulldown.length;a++)changeSellectNode.options[a]=new Option(changePulldown[a-1][0].town,changePulldown[a-1][0].town);changeSellectNode.selectedIndex=0;0!=$("#"+b).length&&(changeZipNode=window.document.getElementById(b),changeZipNode.value=changePulldown[0][0].zip)}else changeSellectNode.options[0]=new Option(c,""),0!=$("#"+b).length&&(changeZipNode=window.document.getElementById(b), changeZipNode.value="")});$("#"+e).on("change",function(){value=$(this).val();changePulldown=f[set_pulldownChangeValue];0!=$("#"+b).length&&(_townData=getObjects(changePulldown,"town",value),changeZipNode=window.document.getElementById(b),changeZipNode.value=""!=_townData?_townData[0].zip:"")})};
